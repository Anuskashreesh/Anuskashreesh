...
Full Stack web developer.  I have a knowledge about back-end development using open source technologies (NodeJs),  front-end development (React, Angular9, C#, HTML5, CSS, Javascript), Server Administrator(AWS,Azure),database(MongoDB, SQL server)
